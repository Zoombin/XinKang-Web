...
<div class="wrap">
	...
	<form id="switch-options-form" method="post" action="options.php" name="switch-options-form">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<fieldset>
						...
						<label for="optimize_options[gravatar-replace]">七牛</label>
						</p>
					</fieldset>
				</td>
			</tr>
			...
			<tr valign="top">
				<th scope="row"><?php _e('移除离线编辑器开放接口', 'optimize_switch'); ?> <span class="info"><abbr title="如果没有使用离线编辑工具（如：微软Live Writer编辑器），可以移除。" rel="tooltip">建议开启</abbr></span></th>
				<td>
					<fieldset>
						<p>
