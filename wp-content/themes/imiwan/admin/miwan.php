...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
        if ( 'save' == $_REQUEST['action'] ) {
            ...
            header("Location: admin.php?page=miwan.php&saved=true");
            die;
        }
    }
...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        <span class="d_themedesc">发布来源：<a href="http://www.imiwan.com/" target="_blank">美玩网</a> &nbsp;&nbsp; <a href="http://www.imiwan.com/theme.html" target="_blank">访问<?php echo $themename; ?>主页</a></span><span style="font-size:16px;color: rgb(245, 99, 99);padding-left:20px;">觉得主题不错？支持一下我继续更新吧 -><a href="http://www.imiwan.com/pay" target="_blank">捐赠</a></span>
    </h2>
<div class="imiwantips">
    <?php
        if (function_exists('curl_init')) {
            $url = "http://7oxhu9.com1.z0.glb.clouddn.com/miwan.txt";
            $ch = curl_init();
            ...
            echo '对不起！貌似您的网站环境尚未开启curl扩展，无法收到来自美玩的通知，请联系您的主机商开启，本地调试请无视';
        }
    ?>
    </div>
<form method="post" class="d_formwrap">
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp; &nbsp;
            <span class="d_tip">开启后请确保您的后台-文章中设置了4篇以上的置顶文章,并且文章第一张图片像素为856*300</span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      列表Ajax加载分页内容
        ...
        是否固定头部导航  <label class="checkbox inline">
                <input type="checkbox" id="d_fixedMenu_b" name="d_fixedMenu_b" <?php if(dopt('d_fixedMenu_b')) echo 'checked="checked"' ?>>开启
            </label>
        </td>
    </tr>
 <tr>
 ...
 <tr>
	...
	<tr>
        <td class="d_tit">是否开启自定义注册功能</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_register_b" name="d_register_b" <?php if(dopt('d_register_b')) echo 'checked="checked"' ?>>开启
                &nbsp; &nbsp;
                <span class="d_tip">开启后，可自定义注册功能使网站更安全，建议开启，开启后填写下面的问题和答案</span>
            </label>
        </td>
    </tr>
	<tr>
        <td class="d_tit">注册验证问题</td>
        <td>
            注册验证问题：<input class="d_inp_short" name="d_registerwt" id="d_registerwt" type="text" value="<?php echo dopt('d_registerwt'); ?>">
        </td>
    </tr>
	<tr>
        <td class="d_tit">注册回答答案</td>
        <td>
            注册回答答案：<input class="d_inp_short" name="d_registerda" id="d_registerda" type="text" value="<?php echo dopt('d_registerda'); ?>">
        </td>
    </tr>
    <tr>
   ...
   <tr>
	...
	<tr>
        <td class="d_tit">网址导航页面一句话文字</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_navtitle_b" name="d_navtitle_b" <?php if(dopt('d_navtitle_b')) echo 'checked="checked"' ?>>开启
<span class="d_tip">会出现在网址导航页面替换“一个有用的网址导航”字样</span>
            </label>
            <textarea name="d_navtitle" id="d_navtitle" type="text" rows="2"><?php echo dopt('d_navtitle'); ?></textarea>
