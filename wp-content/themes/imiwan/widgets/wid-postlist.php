...
class d_postlist extends WP_Widget {
	function d_postlist() {
		$widget_ops = array( 'classname' => 'widget_recent_entries', 'description' => '图文展示（最新文章+热门文章+随机文章）' );
...
?>
<li><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" ><?php if( $img ){echo '<span class="thumbnail">';echo '<img src="'.get_bloginfo("template_url").'/timthumb.php?src=';echo post_thumbnail_src();echo '&h=64&w=100&q=90&zc=1&ct=1" alt="'.get_the_title().'" /></span>'; }else{$img = '';} ?><span class="text"><?php the_title(); ?></span></a></li>
<?php
